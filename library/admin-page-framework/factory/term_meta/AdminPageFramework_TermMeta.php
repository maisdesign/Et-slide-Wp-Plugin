...
abstract class EtTapListSlider_AdminPageFramework_TermMeta_Router extends EtTapListSlider_AdminPageFramework_TaxonomyField_Controller {
}
abstract class EtTapListSlider_AdminPageFramework_TermMeta_Model extends EtTapListSlider_AdminPageFramework_TermMeta_Router {
    ...
    private function _getSavedTermMetas($iTermID, array $aFieldsets) {
        $_oMetaData = new EtTapListSlider_AdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
...
abstract class EtTapListSlider_AdminPageFramework_TermMeta_View extends EtTapListSlider_AdminPageFramework_TermMeta_Model {
...
abstract class EtTapListSlider_AdminPageFramework_TermMeta_Controller extends EtTapListSlider_AdminPageFramework_TermMeta_View {
}
abstract class EtTapListSlider_AdminPageFramework_TermMeta extends EtTapListSlider_AdminPageFramework_TermMeta_Controller {
    protected $_sStructureType = 'term_meta';
    public function __construct($asTaxonomySlug, $sCapability = 'manage_options', $sTextDomain = 'et-tap-list-slider') {

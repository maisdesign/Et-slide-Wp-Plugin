...
abstract class EtTapListSlider_AdminPageFramework_TaxonomyField_Router extends EtTapListSlider_AdminPageFramework_Factory {
...
abstract class EtTapListSlider_AdminPageFramework_TaxonomyField_Model extends EtTapListSlider_AdminPageFramework_TaxonomyField_Router {
...
abstract class EtTapListSlider_AdminPageFramework_TaxonomyField_View extends EtTapListSlider_AdminPageFramework_TaxonomyField_Model {
...
abstract class EtTapListSlider_AdminPageFramework_TaxonomyField_Controller extends EtTapListSlider_AdminPageFramework_TaxonomyField_View {
    public function setUp() {
    }
}
abstract class EtTapListSlider_AdminPageFramework_TaxonomyField extends EtTapListSlider_AdminPageFramework_TaxonomyField_Controller {
    protected $_sStructureType = 'taxonomy_field';
    function __construct($asTaxonomySlug, $sOptionKey = '', $sCapability = 'manage_options', $sTextDomain = 'et-tap-list-slider') {

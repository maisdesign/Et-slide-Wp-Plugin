...
class EtTapListSlider_AdminPageFramework_Property_page_meta_box extends EtTapListSlider_AdminPageFramework_Property_post_meta_box {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'et-tap-list-slider', $sStructureType = 'page_meta_box') {
        unset($this->oAdminPage, $this->aHelpTabs);
        parent::__construct($oCaller, $sClassName, $sCapability, $sTextDomain, $sStructureType);
        $GLOBALS['aEtTapListSlider_AdminPageFramework']['aMetaBoxForPagesClasses'] = $this->getElementAsArray($GLOBALS, array('aEtTapListSlider_AdminPageFramework', 'aMetaBoxForPagesClasses'));
        $GLOBALS['aEtTapListSlider_AdminPageFramework']['aMetaBoxForPagesClasses'][$sClassName] = $oCaller;
    }
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        $_aPageClasses = $this->getElementAsArray($GLOBALS, array('aEtTapListSlider_AdminPageFramework', 'aPageClasses'));

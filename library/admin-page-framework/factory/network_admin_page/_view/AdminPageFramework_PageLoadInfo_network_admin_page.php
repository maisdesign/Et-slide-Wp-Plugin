...
class EtTapListSlider_AdminPageFramework_PageLoadInfo_network_admin_page extends EtTapListSlider_AdminPageFramework_PageLoadInfo_Base {
    ...
    public static function instantiate($oProp, $oMsg) {
        ...
        self::$_oInstance = new EtTapListSlider_AdminPageFramework_PageLoadInfo_network_admin_page($oProp, $oMsg);
        return self::$_oInstance;
    }

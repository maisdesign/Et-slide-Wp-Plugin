...
class EtTapListSlider_AdminPageFramework_Property_post_meta_box extends EtTapListSlider_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'edit_posts', $sTextDomain = 'et-tap-list-slider', $sStructureType = 'post_meta_box') {

...
abstract class EtTapListSlider_AdminPageFramework_MetaBox_Router extends EtTapListSlider_AdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'et-tap-list-slider') {
...
abstract class EtTapListSlider_AdminPageFramework_MetaBox_Model extends EtTapListSlider_AdminPageFramework_MetaBox_Router {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'et-tap-list-slider') {
    ...
    public function _replyToGetSavedFormData() {
        $_oMetaData = new EtTapListSlider_AdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
...
abstract class EtTapListSlider_AdminPageFramework_MetaBox_View extends EtTapListSlider_AdminPageFramework_MetaBox_Model {
...
abstract class EtTapListSlider_AdminPageFramework_MetaBox_Controller extends EtTapListSlider_AdminPageFramework_MetaBox_View {
...
abstract class EtTapListSlider_AdminPageFramework_MetaBox extends EtTapListSlider_AdminPageFramework_MetaBox_Controller {

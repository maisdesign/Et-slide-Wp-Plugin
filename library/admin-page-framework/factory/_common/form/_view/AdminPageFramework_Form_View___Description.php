...
class EtTapListSlider_AdminPageFramework_Form_View___Description extends EtTapListSlider_AdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'et-tap-list-slider-form-element-description';

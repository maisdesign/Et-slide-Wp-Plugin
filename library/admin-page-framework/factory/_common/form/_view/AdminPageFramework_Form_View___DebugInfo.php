...
class EtTapListSlider_AdminPageFramework_Form_View___DebugInfo extends EtTapListSlider_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='et-tap-list-slider-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }

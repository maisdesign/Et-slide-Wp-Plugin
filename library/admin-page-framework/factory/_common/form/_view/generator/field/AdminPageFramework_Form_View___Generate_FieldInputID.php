...
class EtTapListSlider_AdminPageFramework_Form_View___Generate_FieldTagID extends EtTapListSlider_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
...
class EtTapListSlider_AdminPageFramework_Form_View___Generate_FieldInputID extends EtTapListSlider_AdminPageFramework_Form_View___Generate_FieldTagID {
    public $isIndex = '';

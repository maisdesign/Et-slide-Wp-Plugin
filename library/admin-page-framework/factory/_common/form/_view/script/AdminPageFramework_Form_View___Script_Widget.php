...
class EtTapListSlider_AdminPageFramework_Form_View___Script_Widget extends EtTapListSlider_AdminPageFramework_Form_View___Script_Base {
    ...
    $( document ).ready( function() {
        ...
        $( document ).ajaxComplete( function( event, XMLHttpRequest, ajaxOptions ) {
            ...
            if( _aRequest.action && ( 'save-widget' === _aRequest.action ) ) {
                ...
                if ( $( _oWidget ).find( '.et-tap-list-slider-sectionset' ).length <= 0 ) { 
                    return; 
                }   
                ...
                $( document ).trigger( 
                    'et-tap-list-slider_saved_widget', 
                    _oWidget 
                );

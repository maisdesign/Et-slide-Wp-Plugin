...
class EtTapListSlider_AdminPageFramework_Form_View___Script_SectionTab extends EtTapListSlider_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.et-tap-list-slider-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='et-tap-list-slider-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}

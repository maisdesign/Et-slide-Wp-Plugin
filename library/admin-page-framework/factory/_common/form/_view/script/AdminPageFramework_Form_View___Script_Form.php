...
class EtTapListSlider_AdminPageFramework_Form_View___Script_Form extends EtTapListSlider_AdminPageFramework_Form_View___Script_Base {
    static public function getScript() {
        return <<<JAVASCRIPTS
( function( $ ) {

    var _removeEtTapListSlider_AdminPageFrameworkLoadingOutputs = function() {

        jQuery( '.et-tap-list-slider-form-loading' ).remove();
        jQuery( '.et-tap-list-slider-form-js-on' )
            .hide()
            .css( 'visibility', 'visible' )
            .fadeIn( 200 )
            .removeClass( '.et-tap-list-slider-form-js-on' );
    ...
    window.onerror = function(){
        ...
        _removeEtTapListSlider_AdminPageFrameworkLoadingOutputs();

...
class EtTapListSlider_AdminPageFramework_Form___SubmitNotice extends EtTapListSlider_AdminPageFramework_FrameworkUtility {
    ...
    public function render() {
        new EtTapListSlider_AdminPageFramework_AdminNotice('');
    ...
    private function _printNotices($aNotices) {
        ...
        foreach (array_filter(( array )$aNotices, 'is_array') as $_aNotice) {
            ...
            new EtTapListSlider_AdminPageFramework_AdminNotice($this->getElement($_aNotice, 'sMessage'), $this->getElement($_aNotice, 'aAttributes'));
        }
    }
}

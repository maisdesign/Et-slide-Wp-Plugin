...
class EtTapListSlider_AdminPageFramework_FieldType_text extends EtTapListSlider_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('text', 'password', 'date', 'datetime', 'datetime-local', 'email', 'month', 'search', 'tel', 'url', 'week',);
    protected $aDefaultKeys = array();
    protected function getStyles() {
        return ".et-tap-list-slider-field.et-tap-list-slider-field-text > .et-tap-list-slider-input-label-container {vertical-align: middle; }.et-tap-list-slider-field.et-tap-list-slider-field-text > .et-tap-list-slider-input-label-container.et-tap-list-slider-field-text-multiple-labels {display: block;}";
    }
    ...
    private function _getFieldOutputByLabel($sKey, $sLabel, $aField) {
        ...
        $_sClassSelector = $_bIsArray ? 'et-tap-list-slider-field-text-multiple-labels' : '';
        ...
        $_aOutput = array($this->getElementByLabel($aField['before_label'], $sKey, $aField['label']), "<div class='et-tap-list-slider-input-label-container {$_sClassSelector}'>", "<label for='" . $_aInputAttributes['id'] . "'>", $this->getElementByLabel($aField['before_input'], $sKey, $aField['label']), $_sLabel ? "<span " . $this->getLabelContainerAttributes($aField, 'et-tap-list-slider-input-label-string') . ">" . $_sLabel . "</span>" : '', "<input " . $this->getAttributes($_aInputAttributes) . " />", $this->getElementByLabel($aField['after_input'], $sKey, $aField['label']), "</label>", "</div>", $this->getElementByLabel($aField['after_label'], $sKey, $aField['label']),);
        return implode('', $_aOutput);
    }
}
class EtTapListSlider_AdminPageFramework_FieldType_file extends EtTapListSlider_AdminPageFramework_FieldType_text {

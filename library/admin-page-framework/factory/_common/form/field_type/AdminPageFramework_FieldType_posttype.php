...
class EtTapListSlider_AdminPageFramework_FieldType_checkbox extends EtTapListSlider_AdminPageFramework_FieldType {
...
JAVASCRIPTS;
    ...
    private function _getSelectButtonClassSelectors(array $aFieldTypeSlugs, $sDataAttribute = 'select_all_button') {
        ...
        foreach ($aFieldTypeSlugs as $_sSlug) {
            ...
            $_aClassSelectors[] = '.et-tap-list-slider-checkbox-container-' . $_sSlug . "[data-{$sDataAttribute}]";
        }
        return implode(',', $_aClassSelectors);
    }
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.et-tap-list-slider-checkbox-label {margin-top: 0.1em;}.et-tap-list-slider-field input[type='checkbox' ] {margin-right: 0.5em;} .et-tap-list-slider-field-checkbox .et-tap-list-slider-input-label-container {padding-right: 1em;}.et-tap-list-slider-field-checkbox .et-tap-list-slider-input-label-string{display: inline; }";
    }
...
class EtTapListSlider_AdminPageFramework_FieldType_posttype extends EtTapListSlider_AdminPageFramework_FieldType_checkbox {
    ...
    protected function getStyles() {
        ...
        return $_sParentStyles . ".et-tap-list-slider-field input[type='checkbox'] {margin-right: 0.5em;} .et-tap-list-slider-field-posttype .et-tap-list-slider-input-label-container {padding-right: 1em;}";
    }
    protected function getField($aField) {

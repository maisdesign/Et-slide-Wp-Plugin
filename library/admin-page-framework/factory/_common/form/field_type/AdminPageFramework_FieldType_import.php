...
class EtTapListSlider_AdminPageFramework_FieldType_import extends EtTapListSlider_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".et-tap-list-slider-field-import input {margin-right: 0.5em;}.et-tap-list-slider-field-import label,.form-table td fieldset.et-tap-list-slider-fieldset .et-tap-list-slider-field-import label { display: inline; }";
    }

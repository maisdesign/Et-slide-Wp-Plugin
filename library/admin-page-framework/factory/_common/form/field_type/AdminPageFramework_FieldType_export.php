...
class EtTapListSlider_AdminPageFramework_FieldType_submit extends EtTapListSlider_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".et-tap-list-slider-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'et-tap-list-slider-input-label-container' . ' et-tap-list-slider-input-button-container' . ' et-tap-list-slider-input-container',);
    }
...
class EtTapListSlider_AdminPageFramework_FieldType_export extends EtTapListSlider_AdminPageFramework_FieldType_submit {

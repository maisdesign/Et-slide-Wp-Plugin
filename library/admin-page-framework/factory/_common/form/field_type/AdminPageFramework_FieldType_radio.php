...
class EtTapListSlider_AdminPageFramework_FieldType_radio extends EtTapListSlider_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".et-tap-list-slider-field input[type='radio'] {margin-right: 0.5em;} .et-tap-list-slider-field-radio .et-tap-list-slider-input-label-container {padding-right: 1em;} .et-tap-list-slider-field-radio .et-tap-list-slider-input-container {display: inline;} .et-tap-list-slider-field-radio .et-tap-list-slider-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.et-tap-list-slider-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );

...
abstract class EtTapListSlider_AdminPageFramework_Form_Model___Format_FormField_Base extends EtTapListSlider_AdminPageFramework_Form_Utility {
}
class EtTapListSlider_AdminPageFramework_Form_Model___Format_EachField extends EtTapListSlider_AdminPageFramework_Form_Model___Format_FormField_Base {
    ...
    public function get() {
        ...
        $_oInputTagIDGenerator = new EtTapListSlider_AdminPageFramework_Form_View___Generate_FieldInputID($_aField, $this->isIndex, $this->aCallbacks['hfID']);
        $_aField['input_id'] = $_oInputTagIDGenerator->get();
        $_oFieldInputNameGenerator = new EtTapListSlider_AdminPageFramework_Form_View___Generate_FieldInputName($_aField, $this->getAOrB($_aField['_is_multiple_fields'], $this->isIndex, ''), $this->aCallbacks['hfInputName']);
        $_aField['_input_name'] = $_oFieldInputNameGenerator->get();
        $_oFieldFlatInputName = new EtTapListSlider_AdminPageFramework_Form_View___Generate_FlatFieldInputName($_aField, $this->getAOrB($_aField['_is_multiple_fields'], $this->isIndex, ''), $this->aCallbacks['hfInputNameFlat']);
        ...
        $_aField['_field_object'] = new EtTapListSlider_AdminPageFramework_ArrayHandler($_aField);
        return $_aField;
    }
}

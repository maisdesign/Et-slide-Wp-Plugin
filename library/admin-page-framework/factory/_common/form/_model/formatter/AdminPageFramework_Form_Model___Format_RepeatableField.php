...
class EtTapListSlider_AdminPageFramework_Form_Model___Format_RepeatableSection extends EtTapListSlider_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : EtTapListSlider_AdminPageFramework_Message::getInstance();
    }
    public function get() {
...
class EtTapListSlider_AdminPageFramework_Form_Model___Format_RepeatableField extends EtTapListSlider_AdminPageFramework_Form_Model___Format_RepeatableSection {
    protected function _getDefaultMessage() {

...
abstract class EtTapListSlider_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'EtTapListSlider_AdminPageFramework_Form_', 'oPageLoadInfo' => 'EtTapListSlider_AdminPageFramework_PageLoadInfo_', 'oResource' => 'EtTapListSlider_AdminPageFramework_Resource_', 'oHelpPane' => 'EtTapListSlider_AdminPageFramework_HelpPane_', 'oLink' => 'EtTapListSlider_AdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'EtTapListSlider_AdminPageFramework_Debug', 'oUtil' => 'EtTapListSlider_AdminPageFramework_FrameworkUtility', 'oMsg' => 'EtTapListSlider_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(EtTapListSlider_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return EtTapListSlider_AdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
...
abstract class EtTapListSlider_AdminPageFramework_Factory_Model extends EtTapListSlider_AdminPageFramework_Factory_Router {
    public function __construct($oProp) {
...
abstract class EtTapListSlider_AdminPageFramework_Factory_View extends EtTapListSlider_AdminPageFramework_Factory_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        new EtTapListSlider_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
...
abstract class EtTapListSlider_AdminPageFramework_Factory_Controller extends EtTapListSlider_AdminPageFramework_Factory_View {
...
abstract class EtTapListSlider_AdminPageFramework_Factory extends EtTapListSlider_AdminPageFramework_Factory_Controller {
}

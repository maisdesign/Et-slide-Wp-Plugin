...
abstract class EtTapListSlider_AdminPageFramework_Property_Base extends EtTapListSlider_AdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'et-tap-list-slider' : $sTextDomain;
    ...
    private function ___setGlobals() {
        if (!isset($GLOBALS['aEtTapListSlider_AdminPageFramework'])) {
            $GLOBALS['aEtTapListSlider_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => EtTapListSlider_AdminPageFramework_Registry::NAME, 'sURI' => EtTapListSlider_AdminPageFramework_Registry::URI, 'sScriptName' => EtTapListSlider_AdminPageFramework_Registry::NAME, 'sLibraryName' => EtTapListSlider_AdminPageFramework_Registry::NAME, 'sLibraryURI' => EtTapListSlider_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => EtTapListSlider_AdminPageFramework_Registry::getVersion(), 'sDescription' => EtTapListSlider_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => EtTapListSlider_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => EtTapListSlider_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => EtTapListSlider_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => EtTapListSlider_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new EtTapListSlider_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
}

...
class EtTapListSlider_AdminPageFramework_FrameworkUtility extends EtTapListSlider_AdminPageFramework_WPUtility {
    ...
    static public function getFrameworkVersion($bTrimDevVer = false) {
        $_sVersion = EtTapListSlider_AdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    static public function getFrameworkName() {
        return EtTapListSlider_AdminPageFramework_Registry::NAME;
    }
    static public function getFrameworkNameVersion() {
        return self::getFrameworkName() . ' ' . self::getFrameworkVersion();
    }
}
class EtTapListSlider_AdminPageFramework_ArrayHandler extends EtTapListSlider_AdminPageFramework_FrameworkUtility {
    public $aData = array();

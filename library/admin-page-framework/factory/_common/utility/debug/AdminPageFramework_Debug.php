...
class EtTapListSlider_AdminPageFramework_Debug_Base extends EtTapListSlider_AdminPageFramework_FrameworkUtility {
...
class EtTapListSlider_AdminPageFramework_Debug_Log extends EtTapListSlider_AdminPageFramework_Debug_Base {
...
class EtTapListSlider_AdminPageFramework_Debug extends EtTapListSlider_AdminPageFramework_Debug_Log {
    ...
    static public function dumpArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('EtTapListSlider_AdminPageFramework_Debug::' . __FUNCTION__, 'EtTapListSlider_AdminPageFramework_Debug::dump()');
        EtTapListSlider_AdminPageFramework_Debug::dump($asArray, $sFilePath);
    }
    static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
        self::showDeprecationNotice('EtTapListSlider_AdminPageFramework_Debug::' . __FUNCTION__, 'EtTapListSlider_AdminPageFramework_Debug::get()');
        return EtTapListSlider_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
    }
    static public function logArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('EtTapListSlider_AdminPageFramework_Debug::' . __FUNCTION__, 'EtTapListSlider_AdminPageFramework_Debug::log()');
        EtTapListSlider_AdminPageFramework_Debug::log($asArray, $sFilePath);
    }
    static public function getAsString($mValue) {
        self::showDeprecationNotice('EtTapListSlider_AdminPageFramework_Debug::' . __FUNCTION__);

...
abstract class EtTapListSlider_AdminPageFramework_Utility_Deprecated {
    static public function minifyCSS($sCSSRules) {
        EtTapListSlider_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getCSSMinified()');
        return EtTapListSlider_AdminPageFramework_Utility_String::getCSSMinified($sCSSRules);
    }
    static public function sanitizeLength($sLength, $sUnit = 'px') {
        EtTapListSlider_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getLengthSanitized()');
        return EtTapListSlider_AdminPageFramework_Utility_String::getLengthSanitized($sLength, $sUnit);
    }
    public static function getCorrespondingArrayValue($vSubject, $sKey, $sDefault = '', $bBlankToDefault = false) {
        EtTapListSlider_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getElement()');
        if (!isset($vSubject)) {
            return $sDefault;
        }
    ...
    static public function isAssociativeArray(array $aArray) {
        EtTapListSlider_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__);
    ...
    static public function getAttributes(array $aAttributes) {
        EtTapListSlider_AdminPageFramework_Utility::showDeprecationNotice(__METHOD__, 'EtTapListSlider_AdminPageFramework_WPUtility::getAttributes()');
        $_sQuoteCharactor = "'";
        $_aOutput = array();
...
abstract class EtTapListSlider_AdminPageFramework_Utility_VariableType extends EtTapListSlider_AdminPageFramework_Utility_Deprecated {
...
abstract class EtTapListSlider_AdminPageFramework_Utility_String extends EtTapListSlider_AdminPageFramework_Utility_VariableType {
...
abstract class EtTapListSlider_AdminPageFramework_Utility_Array extends EtTapListSlider_AdminPageFramework_Utility_String {
...
abstract class EtTapListSlider_AdminPageFramework_Utility_ArrayGetter extends EtTapListSlider_AdminPageFramework_Utility_Array {
...
abstract class EtTapListSlider_AdminPageFramework_Utility_ArraySetter extends EtTapListSlider_AdminPageFramework_Utility_ArrayGetter {
...
abstract class EtTapListSlider_AdminPageFramework_Utility_Path extends EtTapListSlider_AdminPageFramework_Utility_ArraySetter {
...
abstract class EtTapListSlider_AdminPageFramework_Utility_URL extends EtTapListSlider_AdminPageFramework_Utility_Path {
...
abstract class EtTapListSlider_AdminPageFramework_Utility_File extends EtTapListSlider_AdminPageFramework_Utility_URL {
...
abstract class EtTapListSlider_AdminPageFramework_Utility_SystemInformation extends EtTapListSlider_AdminPageFramework_Utility_File {
...
abstract class EtTapListSlider_AdminPageFramework_Utility_HTMLAttribute extends EtTapListSlider_AdminPageFramework_Utility_SystemInformation {
...
class EtTapListSlider_AdminPageFramework_Utility extends EtTapListSlider_AdminPageFramework_Utility_HTMLAttribute {

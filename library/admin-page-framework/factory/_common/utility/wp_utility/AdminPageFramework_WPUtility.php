...
class EtTapListSlider_AdminPageFramework_WPUtility_URL extends EtTapListSlider_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(EtTapListSlider_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(EtTapListSlider_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $_sRelativePath = EtTapListSlider_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
...
class EtTapListSlider_AdminPageFramework_WPUtility_HTML extends EtTapListSlider_AdminPageFramework_WPUtility_URL {
...
class EtTapListSlider_AdminPageFramework_WPUtility_Page extends EtTapListSlider_AdminPageFramework_WPUtility_HTML {
...
class EtTapListSlider_AdminPageFramework_WPUtility_Hook extends EtTapListSlider_AdminPageFramework_WPUtility_Page {
...
class EtTapListSlider_AdminPageFramework_WPUtility_File extends EtTapListSlider_AdminPageFramework_WPUtility_Hook {
...
class EtTapListSlider_AdminPageFramework_WPUtility_Option extends EtTapListSlider_AdminPageFramework_WPUtility_File {
...
class EtTapListSlider_AdminPageFramework_WPUtility_Meta extends EtTapListSlider_AdminPageFramework_WPUtility_Option {
...
class EtTapListSlider_AdminPageFramework_WPUtility_SiteInformation extends EtTapListSlider_AdminPageFramework_WPUtility_Meta {
...
class EtTapListSlider_AdminPageFramework_WPUtility_SystemInformation extends EtTapListSlider_AdminPageFramework_WPUtility_SiteInformation {
...
class EtTapListSlider_AdminPageFramework_WPUtility extends EtTapListSlider_AdminPageFramework_WPUtility_SystemInformation {

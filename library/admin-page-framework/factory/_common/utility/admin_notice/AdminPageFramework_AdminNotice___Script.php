...
class EtTapListSlider_AdminPageFramework_AdminNotice___Script extends EtTapListSlider_AdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.et-tap-list-slider-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='et-tap-list-slider-admin-notice-animation-container'></div>" );

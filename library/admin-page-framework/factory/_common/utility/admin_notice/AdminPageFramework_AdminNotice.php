...
class EtTapListSlider_AdminPageFramework_AdminNotice extends EtTapListSlider_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'et-tap-list-slider-settings-notice-message', 'et-tap-list-slider-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new EtTapListSlider_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }

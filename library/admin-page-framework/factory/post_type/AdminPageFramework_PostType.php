...
abstract class EtTapListSlider_AdminPageFramework_PostType_Router extends EtTapListSlider_AdminPageFramework_Factory {
...
abstract class EtTapListSlider_AdminPageFramework_PostType_Model extends EtTapListSlider_AdminPageFramework_PostType_Router {
    public function __construct($oProp) {
        parent::__construct($oProp);
        ...
        if ($this->oProp->bIsAdmin) {
            ...
            if ($this->oProp->sCallerPath) {
                new EtTapListSlider_AdminPageFramework_PostType_Model__FlushRewriteRules($this);
            }
        }
    }
    ...
    public function _replyToRegisterPostType() {
        ...
        new EtTapListSlider_AdminPageFramework_PostType_Model__SubMenuOrder($this);
    }
...
abstract class EtTapListSlider_AdminPageFramework_PostType_View extends EtTapListSlider_AdminPageFramework_PostType_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        if ($this->oProp->bIsAdmin) {
    ...
    public function _replyToPrintStyle() {
        ...
        if (!empty($this->oProp->sStyle)) {
            echo "<style type='text/css' id='et-tap-list-slider-style-post-type'>" . $this->oProp->sStyle . "</style>";
        }
    }
...
abstract class EtTapListSlider_AdminPageFramework_PostType_Controller extends EtTapListSlider_AdminPageFramework_PostType_View {
...
abstract class EtTapListSlider_AdminPageFramework_PostType extends EtTapListSlider_AdminPageFramework_PostType_Controller {
    protected $_sStructureType = 'post_type';
    public function __construct($sPostType, $aArguments = array(), $sCallerPath = null, $sTextDomain = 'et-tap-list-slider') {
        if (empty($sPostType)) {
            return;
        }
        ...
        $this->oProp->sPostType = EtTapListSlider_AdminPageFramework_WPUtility::sanitizeSlug($sPostType);
        $this->oProp->aPostTypeArgs = $aArguments;
    ...
    private function _getCallerScriptPath($sCallerPath) {
        ...
        $_sPageNow = EtTapListSlider_AdminPageFramework_Utility::getElement($GLOBALS, 'pagenow');
        if (in_array($_sPageNow, array('edit.php', 'post.php', 'post-new.php', 'plugins.php', 'tags.php', 'edit-tags.php', 'term.php'))) {
            return EtTapListSlider_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
        }
        return null;
    }
}

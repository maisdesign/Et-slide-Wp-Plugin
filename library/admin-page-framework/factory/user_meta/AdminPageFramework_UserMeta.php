...
abstract class EtTapListSlider_AdminPageFramework_UserMeta_Router extends EtTapListSlider_AdminPageFramework_Factory {
...
abstract class EtTapListSlider_AdminPageFramework_UserMeta_Model extends EtTapListSlider_AdminPageFramework_UserMeta_Router {
    public function _replyToGetSavedFormData() {
        $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
        $_oMetaData = new EtTapListSlider_AdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
...
abstract class EtTapListSlider_AdminPageFramework_UserMeta_View extends EtTapListSlider_AdminPageFramework_UserMeta_Model {
...
abstract class EtTapListSlider_AdminPageFramework_UserMeta_Controller extends EtTapListSlider_AdminPageFramework_UserMeta_View {
...
abstract class EtTapListSlider_AdminPageFramework_UserMeta extends EtTapListSlider_AdminPageFramework_UserMeta_Controller {
    protected $_sStructureType = 'user_meta';
    public function __construct($sCapability = 'read', $sTextDomain = 'et-tap-list-slider') {

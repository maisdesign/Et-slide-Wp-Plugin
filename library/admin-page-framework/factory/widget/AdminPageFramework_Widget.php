...
abstract class EtTapListSlider_AdminPageFramework_Widget_Router extends EtTapListSlider_AdminPageFramework_Factory {
...
abstract class EtTapListSlider_AdminPageFramework_Widget_Model extends EtTapListSlider_AdminPageFramework_Widget_Router {
    ...
    public function _replyToRegisterWidget() {
        ...
        $wp_widget_factory->widgets[$this->oProp->sClassName] = new EtTapListSlider_AdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, $this->oUtil->getAsArray($this->oProp->aWidgetArguments));
        $this->oProp->oWidget = $wp_widget_factory->widgets[$this->oProp->sClassName];
    }
}
abstract class EtTapListSlider_AdminPageFramework_Widget_View extends EtTapListSlider_AdminPageFramework_Widget_Model {
...
abstract class EtTapListSlider_AdminPageFramework_Widget_Controller extends EtTapListSlider_AdminPageFramework_Widget_View {
...
abstract class EtTapListSlider_AdminPageFramework_Widget extends EtTapListSlider_AdminPageFramework_Widget_Controller {
    protected $_sStructureType = 'widget';
    public function __construct($sWidgetTitle, $aWidgetArguments = array(), $sCapability = 'edit_theme_options', $sTextDomain = 'et-tap-list-slider') {

...
class EtTapListSlider_AdminPageFramework_Property_widget extends EtTapListSlider_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'et-tap-list-slider', $sStructureType) {

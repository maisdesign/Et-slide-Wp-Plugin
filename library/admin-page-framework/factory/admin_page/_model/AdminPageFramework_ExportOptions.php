...
abstract class EtTapListSlider_AdminPageFramework_CustomSubmitFields extends EtTapListSlider_AdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
...
class EtTapListSlider_AdminPageFramework_ExportOptions extends EtTapListSlider_AdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (in_array(gettype($vData), array('array', 'object'))) {
                    echo EtTapListSlider_AdminPageFramework_Debug::get($vData, null, false);
                }
                echo $vData;
                return;
            case 'json':

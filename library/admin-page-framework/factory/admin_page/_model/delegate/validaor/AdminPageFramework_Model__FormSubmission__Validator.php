...
class EtTapListSlider_AdminPageFramework_Model__FormSubmission__Validator_Base extends EtTapListSlider_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
...
class EtTapListSlider_AdminPageFramework_Model__FormSubmission__Validator extends EtTapListSlider_AdminPageFramework_Model__FormSubmission__Validator_Base {
    public $oFactory;
    ...
    public function _replyToValiateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('EtTapListSlider_AdminPageFramework_Model__FormSubmission__Validator__Link', 'EtTapListSlider_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'EtTapListSlider_AdminPageFramework_Model__FormSubmission__Validator__Import', 'EtTapListSlider_AdminPageFramework_Model__FormSubmission__Validator__Export', 'EtTapListSlider_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'EtTapListSlider_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'EtTapListSlider_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'EtTapListSlider_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
        ...
        try {
            ...
            $_oFormSubmissionFilter = new EtTapListSlider_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);

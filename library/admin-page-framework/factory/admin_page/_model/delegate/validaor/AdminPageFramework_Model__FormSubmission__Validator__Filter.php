...
class EtTapListSlider_AdminPageFramework_Model__FormSubmission__Validator__Filter extends EtTapListSlider_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;

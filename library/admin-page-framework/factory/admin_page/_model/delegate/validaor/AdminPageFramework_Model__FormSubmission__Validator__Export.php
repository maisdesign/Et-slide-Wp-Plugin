...
class EtTapListSlider_AdminPageFramework_Model__FormSubmission__Validator__Import extends EtTapListSlider_AdminPageFramework_Model__FormSubmission__Validator_Base {
    ...
    private function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new EtTapListSlider_AdminPageFramework_ImportOptions($_FILES['__import'], $_POST['__import']);
...
class EtTapListSlider_AdminPageFramework_Model__FormSubmission__Validator__Export extends EtTapListSlider_AdminPageFramework_Model__FormSubmission__Validator__Import {
    public $sActionHookPrefix = 'try_validation_after_';
    ...
    protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
        $_oExport = new EtTapListSlider_AdminPageFramework_ExportOptions($_POST['__export'], $this->oFactory->oProp->sClassName);

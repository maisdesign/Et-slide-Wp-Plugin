...
abstract class EtTapListSlider_AdminPageFramework_Model__FormSubmission_Base extends EtTapListSlider_AdminPageFramework_FrameworkUtility {
...
class EtTapListSlider_AdminPageFramework_Model__FormSubmission extends EtTapListSlider_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        $this->oFactory = $oFactory;
        $this->_handleFormData();
        new EtTapListSlider_AdminPageFramework_Model__FormRedirectHandler($oFactory);
    }
    public function _handleFormData() {
        ...
        new EtTapListSlider_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);

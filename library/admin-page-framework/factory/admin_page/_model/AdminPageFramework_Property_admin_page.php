...
class EtTapListSlider_AdminPageFramework_Property_admin_page extends EtTapListSlider_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'et-tap-list-slider') {
        ...
        $GLOBALS['aEtTapListSlider_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aEtTapListSlider_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['aEtTapListSlider_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;

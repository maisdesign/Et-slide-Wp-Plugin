 ...
 * @package     EtTapListSlider_AdminPageFramework
 */

if ( ! class_exists( 'EtTapListSlider_PostTypeTaxonomyCustomFieldType' ) ) :
/**
 ...
 */
class EtTapListSlider_PostTypeTaxonomyCustomFieldType extends EtTapListSlider_AdminPageFramework_FieldType_taxonomy {
...
jQuery( document ).ready( function(){
    ...
    jQuery( '.et-tap-list-slider-checkbox-container-posttype[data-select_all_button]' ).each( function( iIndex ){
        jQuery( this ).before( '<div class=\"select_all_button_container\" onclick=\"jQuery( this ).selectAllEtTapListSlider_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_all_button' ) + '</a></div>' );
    });            
    jQuery( '.et-tap-list-slider-checkbox-container-posttype[data-select_none_button]' ).each( function( iIndex ){
        jQuery( this ).before( '<div class=\"select_none_button_container\" onclick=\"jQuery( this ).deselectAllEtTapListSlider_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_none_button' ) + '</a></div>' );
    });
    
    // When the post type check-boxes are clicked, show/hide the corresponding taxonomy elements.
    jQuery( document ).on( 'change', '.et-tap-list-slider-field-post_type_taxonomy .et-tap-list-slider-field-posttype input[type="checkbox"]', function() {
        ...
        var _oField              = jQuery( this ).closest( '.et-tap-list-slider-field-post_type_taxonomy' );
    ...
    jQuery( '.et-tap-list-slider-field-post_type_taxonomy .et-tap-list-slider-field-posttype input[type="checkbox"]:not(:checked)' ).each( function(){
        jQuery( this ).trigger( 'change' );
    } );
    

    jQuery().registerEtTapListSlider_AdminPageFrameworkCallbacks( {
        /**
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            oCloned.find( '.et-tap-list-slider-field-posttype input[type="checkbox"]' )
                .prop( 'checked', false )
                .trigger( 'change' );         
...
.et-tap-list-slider-field-post_type_taxonomy .select_all_button_container, 
.et-tap-list-slider-field-post_type_taxonomy .select_none_button_container
{
...
.et-tap-list-slider-field-post_type_taxonomy .select-taxonomy-terms-checkbox-container {
            ...
            return "<div class='select-taxonomy-terms-checkbox-container'>"
                    . "<label class='select-taxonomy-terms'>"
                        ...
                        . "<input " . $this->getAttributes( $_aCheckboxAttributes ) . " />"
                            . __( 'Select taxonomy terms.', 'et-tap-list-slider-loader' )
                    . "</label>"
                . "</div>";

...
if ( ! class_exists( 'EtTapListSlider_PathCustomFieldType' ) ) :
/**
 ...
 */
class EtTapListSlider_PathCustomFieldType extends EtTapListSlider_AdminPageFramework_FieldType_image {
    ...
    protected function getScripts() {
        ...
        return "jQuery( document ).ready( function(){
            ...
            removeInputValuesForPath = function( oElem ) {
                jQuery( oElem )
                    .closest( '.et-tap-list-slider-field' )
    ...
    public function getField( $aField ) {
        ...
        return
            $aField[ 'before_label' ]
            . "<div class='et-tap-list-slider-input-label-container et-tap-list-slider-input-container {$aField[ 'type' ]}-field'>" 
                . "<label for='{$aField[ 'input_id' ]}'>"
                    . $aField[ 'before_input' ]
                    . $this->getAOrB(
                        $aField[ 'label' ] && ! $aField[ 'repeatable' ],
                        "<span " . $this->getLabelContainerAttributes( $aField, 'et-tap-list-slider-input-label-string' ) . ">" 
                            . $aField[ 'label' ] 
                        . "</span>",                        
                        ''                        
                    )
...
JAVASCRIPTS;
            ...
            return "<script type='text/javascript' class='et-tap-list-slider-{$sType}-remove-button'>"
                    . '/* <![CDATA[ */'
                    . $_sScript 
                    . '/* ]]> */'
                . "</script>". PHP_EOL;
...
jQuery( document ).ready( function(){   
    //setEtTapListSlider_AdminPageFrameworkMediaUploader( '{$sInputID}', 'true' === '{$_sRpeatable}' );
});
JAVASCRIPTS;
                    
            return "<script type='text/javascript' class='et-tap-list-slider-media-uploader-button'>" 
                    . '/* <![CDATA[ */'
                    . $_sScript 
                    . '/* ]]> */'
                . "</script>". PHP_EOL;
                ...
                return "<a " . $this->getAttributes( $_aAttributes ) . ">"
                        . $this->getAOrB( 
                            ...
                            $this->getAOrB(
                                ...
                                '',
                                __( 'Select Path', 'et-tap-list-slider-field-type-pack' )
                            )
                        )
                    ."</a>";

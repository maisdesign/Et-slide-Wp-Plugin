...
if ( ! class_exists( 'EtTapListSlider_Select2CustomFieldType' ) ) :
/**
 ...
 */
class EtTapListSlider_Select2CustomFieldType extends EtTapListSlider_AdminPageFramework_FieldType_select {
...
"jQuery( document ).ready( function(){
    ...
    var _initializeSelect2 = function( oNode ) {
        ...
        if ( _aOptions[ 'width' ] && 'auto' !== _aOptions[ 'width' ] ) {
            var _oFieldContainer = _oSelect2Target.closest( '.et-tap-list-slider-field-select2' );
            _oFieldContainer.css( 'width', _aOptions[ 'width' ] );
            _oFieldContainer.children( '.et-tap-list-slider-select-label' )
                .css( 'width', '100%' );
            _oFieldContainer.children( '.et-tap-list-slider-select-label' )
                .children( 'label' )
                .children( '.et-tap-list-slider-input-container' )
                .css( 'width', '100%' );
            _aOptions[ 'width' ] = '100%';
        }
        ...
        if ( _aOptions[ 'search_callback' ] ) {
             ...
             * Set inital values.
             */
            var _oInputForEncoded = _oSelect2Target.closest( '.et-tap-list-slider-field' )
            ...
            _oSelect2Target.on( 'change', function( event ){
                ...
                jQuery( this ).closest( '.et-tap-list-slider-field' )
                    .children( 'input[data-encoded]' ).first()
    ...
    protected function getStyles() {
        return "
.et-tap-list-slider-field-select2 .select2-container {     
    min-width: 200px;
    width: auto;
}

.et-tap-list-slider-field-select2 {
    max-width: 96%;
}

/* Make a room for repeatable buttons */
.repeatable .et-tap-list-slider-field-select2 > .et-tap-list-slider-select-label > label > .et-tap-list-slider-input-container {
    max-width: 84%;
}

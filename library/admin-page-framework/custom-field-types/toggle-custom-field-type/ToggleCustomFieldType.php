...
if ( ! class_exists( 'EtTapListSlider_ToggleCustomFieldType' ) ) :
/**
 ...
 */
class EtTapListSlider_ToggleCustomFieldType extends EtTapListSlider_AdminPageFramework_FieldType_checkbox {
        ...
        return "jQuery( document ).ready( function(){
            ...
            jQuery( '.switch_toggle_buttons' ).each( function () {
                ...
                jQuery( this ).closest( '.et-tap-list-slider-field' )
                    .children( '.et-tap-list-slider-checkbox-container-toggle' )
                    .hide();

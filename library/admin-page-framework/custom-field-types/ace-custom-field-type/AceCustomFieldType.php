<?php
/**
 * EtTapListSlider_AceCustomFieldType, for the  Admin Page Framework by Michael Uno, is written by Per Soderlind - http://soderlind.no
 */
if ( ! class_exists( 'EtTapListSlider_AceCustomFieldType' ) ) :
class EtTapListSlider_AceCustomFieldType extends EtTapListSlider_AdminPageFramework_FieldType {
            ...
            jQuery().registerAPFCallback( {
                ...
                */
                added_repeatable_field: function( oCopied, sFieldType, sFieldTagID, iCallType ) {
                    ...
                    oCopied.closest( '.et-tap-list-slider-field' ).nextAll().andSelf().each( function( iIndex ) {

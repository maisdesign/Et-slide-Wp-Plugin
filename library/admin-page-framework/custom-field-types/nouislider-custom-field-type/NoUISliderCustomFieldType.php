...
if ( ! class_exists( 'EtTapListSlider_NoUISliderCustomFieldType' ) ) :
/**
 ...
 */
class EtTapListSlider_NoUISliderCustomFieldType extends EtTapListSlider_AdminPageFramework_FieldType_text {

<?php
if ( ! class_exists( 'EtTapListSlider_GitHubCustomFieldType' ) ) :
/**
 * @version     1.0.1
 */
class EtTapListSlider_GitHubCustomFieldType extends EtTapListSlider_AdminPageFramework_FieldType {
    ...
    protected function getField( $aField ) { 
        ...
        return 
            $aField['before_label']
            . "<div class='et-tap-list-slider-input-label-container'>"        
                . $aField['before_input']
                . ( $aField['label'] && ! $aField['repeatable']
                    ? "<span class='et-tap-list-slider-input-label-string' style='min-width:" . $this->getLengthSanitized( $aField['label_min_width'] ) . ";'>" . $aField['label'] . "</span>"
                    : "" 
                )
        ...
        private function _getButtonLabelByType( $sButtonType, $sUserName, $sValue ) {
            ...
            switch( $sButtonType ) {
                case 'follow': 
                    return sprintf( __( 'Follow @%1$s', 'et-tap-list-slider' ), $sUserName );
                case 'watch':
                    return __( 'Watch', 'et-tap-list-slider' );
                case 'star':
                    return __( 'Star', 'et-tap-list-slider' );
                case 'fork':
                    return __( 'Fork', 'et-tap-list-slider' );
                case 'issue':
                    return __( 'Issue', 'et-tap-list-slider' );
                default:
                    return '';
            }                 

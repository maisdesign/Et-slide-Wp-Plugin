...
abstract class EtTapListSlider_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('EtTapListSlider_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new EtTapListSlider_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
